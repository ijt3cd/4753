                ...
                <section style="text-align:center;">
                    ...
                    <table class="inputTable">
                    	<tr>
                    		...
                    		<td class="inputTable" style="background: lightblue;">Points</td>
                    		<td class="inputTable" style="background: lightblue;">Assists</td>
                    		<td class="inputTable" style="background: lightblue;">Rebounds</td>
                    		<td class="inputTable" style="background: lightblue;">Turnovers</td>
                    	</tr>
                    ...
                    <br/>
                    <a href="basketball.php" class="button-smol">Submit</a>
                </section>
